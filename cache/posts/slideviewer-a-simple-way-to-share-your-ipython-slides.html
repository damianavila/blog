...
<pre><code>After some months of silence, I am back...

A lot of things have happened in my life lately, some of them are really good things... some others don&#39;t. 

And all those things kept me very busy, but finally I have made me some time to write again ;-)</code></pre>
<p>OK, I have a long list of news, topics, ideas and developments I want to share with you, but we have to begin with one of them, and the choose one is <code>Slideviewer</code>. <!-- TEASER_END --></p>
...
<p><strong>Slideviewer</strong> lives here (for now): http://slideviewer.herokuapp.com/ and you can see it <em>iframed</em> below:</p>
</div>
<div class="text_cell_render border-box-sizing rendered_html">
