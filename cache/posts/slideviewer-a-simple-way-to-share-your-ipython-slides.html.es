...
<p>OK, I have a long list of news, topics, ideas and developments I want to share with you, but we have to begin with one of them, and the chosen one is <code>Slideviewer</code>.
<!-- TEASER_END --></p>
...
<p><strong>Slideviewer</strong> lives here (for now): <a href="http://slideviewer.herokuapp.com/"><a href="http://slideviewer.herokuapp.com/">http://slideviewer.herokuapp.com/</a></a> and you can see it <em>iframed</em> below:</p>
</div>
</div>
</div>
<div class="cell border-box-sizing text_cell rendered">
