...
</code></pre><p>But we can do it better ;-) 
...
</code></pre><p>Here I have the string <code>title</code> containing the title for the current blog post and a list called <code>tags_list</code> containing the corresponding tags. Later I call the <code>.join</code> method because I will need to pass a string with the tags sepatarated by commas to the <code>nikola new_post</code> command.</p>
...
</code></pre><p>which will create the desired <code>ipynb</code> and the corresponding <code>.meta</code> file containing the title and tags.</p>
...
</code></pre><p><em>Que me contusi!</em> (or... do you see the bidirectional nature of this interaction? Nice, don&#39;t you think?)</p>
...
</code></pre><p>In the <strong>IPython Dashboard</strong>, I will open the new <code>ipynb</code> called <code>bidirectional-ipython-nikola-workflow-to-write-your-blog-post.ipynb</code> and write the content (I am writing right now).</p>
...
</code></pre><p>As you can see, I call <code>nikola clean</code> to clean my site, the I built it with <code>nikola build</code>, and deploy it with my customized <code>nikola deploy</code>... and all these actions with just a click!</p>
