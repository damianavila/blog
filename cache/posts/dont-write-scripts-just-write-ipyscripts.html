...
<div class="highlight"><pre><span class="n">list_of_projects</span> <span class="o">=</span> <span class="p">[</span><span class="s">&quot;ipython&quot;</span><span class="p">,</span> 
                    ...
                    <span class="s">&quot;nbviewer&quot;</span><span class="p">,</span> 
                    <span class="s">&quot;nikola&quot;</span><span class="p">,</span> 
...
<div class="highlight"><pre><span class="k">def</span> <span class="nf">update</span><span class="p">(</span><span class="n">folder</span><span class="p">):</span>
    ...
    <span class="err">!</span><span class="n">git</span> <span class="n">pull</span> <span class="n">origin</span>
...
<pre><code>You can actually do:

for i in list_of_projects: 
    update(i)
print &quot;---------------------------------&quot;

But, this is an example, and I wanted to emphasize the fact that you can pass complex arguments inside the braces... Thanks Lex for your comment, I forgot to add this explanation!</code></pre>
